...
- État du 16 juillet 2026 : la première spritesheet dessinée et validée avec l'utilisateur est intégrée en test uniquement pour la marche vers la gauche de l'Aventurier. Elle contient quatre images transparentes de 48 × 64 px, jouées à 8 images/s avec un ancrage bas-centre. Les directions haut, bas et droite ainsi que l'arrêt et l'attaque restent provisoirement procéduraux jusqu'à leur validation séparée. Cette substitution ne change ni la grille, ni l'interpolation, ni les collisions autoritaires.
